...
require('includes/config.php');
	...
	{
		$msg=array();
		if(empty($_POST['name']) || empty($_POST['description']) || empty($_POST['company']) || empty($_POST['pages']) || empty($_POST['price']))
		{
		...
		else
		{
			...
			$query="insert into notebook(nb_nam,nb_subcat,nb_desc,nb_page,nb_price,nb_img)
			values('$nb_nm','$nb_cat','$nb_desc',$nb_pages,$nb_price,'$nb_img')";
